...
# Seed sabitleme, ayni datayi versin diye degil, sadece karistirmalar sabit olsun diye
...
print("Yeniden Egitim basliyor... Loss dususunu kontrol edecegiz.")
...
plt.plot(range(1, EPOCHS+1), train_losses, label='Train Loss (Egitim Hatasi)', marker='o')
plt.plot(range(1, EPOCHS+1), test_losses, label='Test Loss (Test Hatasi)', marker='s')
plt.title('JEPA Epochlara Gore Hata Dusus Egrisi (Loss Curve)')
plt.xlabel('Epoch (Egitim Turu)')
plt.ylabel('Smooth L1 Loss (Hata Miktari)')
plt.legend()
plt.grid(True)
output_path = r"C:\Users\Acer\.gemini\antigravity-ide\brain\8aa980f3-5dc6-49a2-a0da-b719fbca274e\scratch\loss_curve.png"
