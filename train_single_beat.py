...
test_loader = DataLoader(test_ds, batch_size=BATCH_SIZE, shuffle=False, collate_fn=jepa_single_beat_collate_fn, drop_last=True)

# seq_len=300 ve patch_size=50 (sadece 6 yama)
...
print("Tek Atim (Single-Beat) Egitimi Basliyor...")
...
for epoch in range(1, EPOCHS + 1):
    ...
    if test_losses[-1] < best_loss:
        ...
        torch.save({'model_state_dict': model.state_dict()}, r"C:\Users\Acer\Downloads\jepa\checkpoints\best_jepa_single_beat.pt")
...
plt.title('JEPA Tek-Atim (Single Beat) Loss Egrisi')
plt.xlabel('Epoch')
plt.ylabel('Smooth L1 Loss')
plt.legend()
plt.grid(True)
output_path = r"C:\Users\Acer\.gemini\antigravity-ide\brain\8aa980f3-5dc6-49a2-a0da-b719fbca274e\scratch\loss_curve_single_beat.png"
